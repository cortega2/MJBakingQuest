...
void start::on_pushButton_4_clicked(){
    ...
    msgBox.setText("Press the 'D' key to move Mary Jane Forward. Press the 'A' key to move Mary Jane Backward.                                                "
                   "Press the space bar to pick up or drop blocks. Blocks can be moved to move MJ around the level and cruch enemies.                         "
                   "Also press the space bar when in front of a door to go through it.                                                                        "
                   "Press the 'P' key to save the game. Press the 'R' key to reset the game.");
    msgBox.exec();
